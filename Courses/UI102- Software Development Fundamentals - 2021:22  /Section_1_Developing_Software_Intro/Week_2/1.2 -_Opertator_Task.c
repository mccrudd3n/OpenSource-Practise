...
namespace Hello_World
{
    class Program
    {
        ...
        {
            Console.WriteLine("Select Operation: Addition (a) or Subtract (s)? ");
            string input_operator = Console.ReadLine();

            while (input_operator != "a" || input_operator != "s")
            {
                Console.WriteLine("Invalid operator; Addition (a) or Subtract (s)?");
